...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
      <meta name="google-site-verification" content="5xhEKm673tx5S3yH7BUcIvLnYK9ijnrsqPa8xsBVQNY" />
      <script async src="https://www.googletagmanager.com/gtag/js?id=G-ZR2WZ56RM2"></script>
        <script
